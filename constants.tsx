...
export const TRANSLATIONS = {
  en: {
    ...
    searchPlaceholder: 'Search passport, name or phone...',
  ...
  fr: {
    ...
    searchPlaceholder: 'Rechercher passeport, nom...',
  ...
  ar: {
    ...
    maxSize: 'الحد الأقصى 200 كيلوبايت',
    ...
    searchPlaceholder: 'بحث بالجواز، الاسم...',
